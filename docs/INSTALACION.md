...
| `vehiculos`, `garantias`, `garantia_vehiculo`, `sigm_avisos`, `contratos`, `legal_adjuntos`, `legal_settings`, `tramites_notariales`, `expedientes_judiciales`, `actuaciones_judiciales`, `plazos_judiciales`, `papeletas`, `papeleta_recursos` | **SÍ** | Módulo Área Legal (desde 24/08) — garantías SIGM, avisos, contratos emitidos, notaría, judicial, papeletas y su configuración |
...
mysqldump --single-transaction --quick laravel_prestamo \
  ...
  vehiculos garantias garantia_vehiculo sigm_avisos contratos legal_adjuntos legal_settings tramites_notariales \

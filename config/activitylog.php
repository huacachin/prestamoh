...
return [
     ...
     */
    'actions' => [
        // 25/09: acción propia que añade el contexto (IP, navegador, usuario, ruta) a cada
        // registro y nunca tumba la operación de negocio si falla el insert.
        'log_activity' => GuardarActividad::class,

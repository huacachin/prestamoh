<div class="container-fluid">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="main-title title-modules" style="color:red;">CRONOGRAMA DE PAGOS #{{ $credit->id }}</h4>
        </div>
            ...
            <div class="d-flex gap-2 py-1">
                ...
                @can('reportes.pagos')
                    ...
                    <a href="{{ route('reports.payments', ['credito' => $credit->id, 'desde' => ($credit->fecha_prestamo ?? now())->format('Y-m-d'), 'hasta' => now()->format('Y-m-d')]) }}"
                       class="btn btn-sm btn-info" title="Reporte de pagos de este crédito #{{ $credit->id }}">

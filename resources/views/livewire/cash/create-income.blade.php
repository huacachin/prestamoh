<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-6">
            <h4 class="main-title title-modules">INGRESO GENERALES : NUEVO</h4>
        </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    @unless($canChooseOtros)
                        <div class="alert alert-info py-1 px-2 mb-2" style="font-size:11px;">
                            <i class="ti ti-info-circle"></i>
                            Como Asesor / Cobranza solo puedes registrar ingresos tipo <strong>Fijos</strong> con motivo <strong>Diario</strong>.
                        </div>
                    @endunless
                    ...
                    {{-- Paso 2: form principal (visible solo cuando hay modo elegido) --}}
                    @if($modo)
                                        ...
                                        <div>
                                            ...
                                            <div class="row g-2" @click.stop>
                                                @foreach($files as $i => $f)
                                                    <div class="col-12 col-xl-6">{{-- 26/09: vista previa a la mitad del tamaño real --}}
                                                        <div class="position-relative border rounded p-1 bg-white">
                                                            ...
                                                            @endphp
                                                            @if($tmpUrl)
                                                                <img src="{{ $tmpUrl }}" alt="Preview" class="rounded"
                                                                     style="width:auto; max-width:50%; height:auto; max-height:35vh; display:block; margin:0 auto; background:#fff;">
                                                            @else
                                                                <div class="d-flex align-items-center justify-content-center small text-muted bg-light rounded"
                                                                     style="height:160px;"><i class="ti ti-photo"></i></div>
                                                            @endif
                        ...
                        <div class="d-flex flex-column align-items-center gap-1 mt-3">
                            <div class="d-flex gap-2 justify-content-center flex-wrap">
                                ...
                                <a href="{{ route('cash.incomes') }}" class="btn btn-sm btn-danger">
                    ...
                    @else
                        <div class="text-center text-muted py-4">
                            ...
                            <p class="mt-2 mb-0 small">Seleccione el Tipo de Ingreso para continuar.</p>
                        </div>
                    @endif

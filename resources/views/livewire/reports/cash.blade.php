                        ...
                        <div class="col-12">
                            <div class="d-flex flex-wrap align-items-end gap-2 overflow-auto py-1">
                                <div class="flex-shrink-0" style="width: 170px;">
                                    ...
                                    <input type="text" name="fecha_desde" autocomplete="off" class="form-control form-control-sm dates" wire:model="fecha_desde">
                                </div>
                                <div class="flex-shrink-0" style="width: 170px;">
                                    <label class="form-label mb-0 small">Hasta</label>
                                    <input type="text" name="fecha_hasta" autocomplete="off" class="form-control form-control-sm dates" wire:model="fecha_hasta">
                                </div>

                    ...
                    <div class="row my-2">
                        <div class="col-12">
                            <div class="d-flex flex-wrap align-items-end gap-2 py-1">
                                ...
                                <a href="{{ route('exports.reports.advisor', ['selemes' => $selemes, 'selecano' => $selecano, 'ejecutivo' => $ejecutivo]) }}"
                                   target="_blank"
                                ...
                                <x-scroll-bottom-btn class="flex-shrink-0" scrollable="#tabla-diaria" />
                            </div>
                        </div>
                    </div>

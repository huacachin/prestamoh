...
return [
    ...
    | las reglas de tamaño (size). Puedes ajustar cada uno de estos mensajes.
    |
    */
    ...
    'password'            => [
        ...
        'uncompromised' => 'El campo :attribute ha aparecido en una filtración de datos. Elige un :attribute diferente.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Mensajes de validación personalizados por atributo y regla
    |--------------------------------------------------------------------------
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Reemplaza el marcador :attribute por un nombre más amigable. Útil para
    | que los mensajes muestren "usuario" en lugar de "username".
    |
    */
    ...
    'attributes' => [
        ...
        // Crédito (Create)
        'codigoc'             => 'DNI del cliente',
        'codigod'             => 'cliente',
        'codpre_'             => 'código de préstamo',
        'impopres'            => 'importe del crédito',
        'cuot'                => 'cuotas',
        'inte'                => 'interés',
        'seletipl'            => 'tipo de planilla',
        'nomasesores'         => 'asesor',
        ...
        'code'                => 'código',
        'type'                => 'tipo',
        'factor_ingreso'      => 'factor de ingreso',
        'factor_egreso'       => 'factor de egreso',

    ...
    private function importarVehiculo(string $hoja, int $fila, array $d): void
    {
        ...
        try {
            ...
            if ($vehiculo !== null) {
                ...
                $completados = [];
                if (($vehiculo->anio_modelo === null || (int) $vehiculo->anio_modelo === 0) && $d['anio'] !== null) {
                    $vehiculo->anio_modelo = (string) $d['anio'];
                    $completados[] = 'anio_modelo';
                }
            ...
            Vehiculo::create([
                ...
                'placa' => $d['placa'],
                'anio_modelo' => $d['anio'] !== null ? (string) $d['anio'] : null,
